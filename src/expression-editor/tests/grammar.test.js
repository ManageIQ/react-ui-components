...
describe('field expression', () => {
  let parser;
  beforeEach(() => { parser = new nearley.Parser(nearley.Grammar.fromCompiled(partialGrammar))});
  ...
  it('dont care about anything after caret', () => {
    const input = "vm<<caret_position>>kjdfkjnfdkjfkjfdkjfdkj fdkjfdfdfdkjkjfdkj";
    const expectedOutput = {
  ...
  it('vm.na', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: "na"}],
      next: ["entity", "field"],
      type: 'field',
    };
    parser.feed(input);
  ...
  it('vm.name_', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'field', value: "name"}, {value: ""}],
      next: ["operator"],
      type: 'field',
    };
    parser.feed(input);
  ...
  it('vm.name CON', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'field', value: "name"}, {type: 'operator', value: "CON"}],
      next: ["operator"],
      type: 'field',
    };
    parser.feed(input);
  ...
  it('vm.name CONTAINS_', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'field', value: "name"}, {type: 'operator', value: "CONTAINS"}, {value:''}],
      next: ["value"],
      type: 'field',
    };
    parser.feed(input);
  ...
  it('vm.name CONTAINS "svickova s knedlikem"', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'field', value: "name"}, {type: 'operator', value: "CONTAINS"}, {type: 'value', value:'svickova s knedlikem'}],
      next: ["value"],
      type: 'field',
    };
    parser.feed(input);
  ...
  it('FIELD: vm.name CONTAINS "svickova s knedlikem"', () => {
    const input = 'FIELD: vm.name CONTAINS "svickova s knedlikem"<<caret_position>>';
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'field', value: "name"}, {type: 'operator', value: "CONTAINS"}, {type: 'value', value:'svickova s knedlikem'}],
      next: ["value"],
      type: 'field',
...
describe('tags expression', () => {
  ...
  it('TAGS: "Virtual Machine".Environment', () => {
    ...
    const expectedOutput = {
      results: [{type: "field", value: "Virtual Machine"}, {type: 'entity', value: 'Environment'}],
      next: ["entity", "category"],
      type: 'tag',
    };
    parser.feed(input);
  ...
  it('TAGS: "Virtual Machine".Environment:', () => {
    const input = 'TAGS: "Virtual Machine".Environment:<<caret_position>>';
    const expectedOutput = {
      results: [{type: "field", value: "Virtual Machine"}, {type: 'category', value: 'Environment'}, {type: "operator", value: ":"}, {value: ""}],
      next: ["value"],
      type: 'tag',
    };
    parser.feed(input);
  ...
  it('TAGS: "Virtual Machine".Environment: CONTAINS_', () => {
    const input = 'TAGS: "Virtual Machine".Environment CONTAINS <<caret_position>>';
    const expectedOutput = {
      results: [{type: "field", value: "Virtual Machine"}, {type: 'category', value: 'Environment'}, {type: "operator", value: "CONTAINS"}, {value: ""}],
      next: ["value"],
      type: 'tag',
    };
    parser.feed(input);
  ...
  it('TAGS: "Virtual Machine".Environment: CONTAINS Developement', () => {
    const input = 'TAGS: "Virtual Machine".Environment CONTAINS Developement<<caret_position>>';
    const expectedOutput = {
      results: [{type: "field", value: "Virtual Machine"}, {type: 'category', value: 'Environment'}, {type: "operator", value: "CONTAINS"}, {type: 'value', value: "Developement"}],
      next: ["value"],
      type: 'tag',
    };
    parser.feed(input);
...
describe('count of expression', () => {
  ...
  it('COUNT OF: vm >', () => {
    const input = 'COUNT OF: vm ><<caret_position>>';
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'operator', value: '>'}, {value: ''}],
      next: ["value"],
      type: 'count of',
    };
    parser.feed(input);
  ...
  it('COUNT OF: vm > 10', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'operator', value: '>'}, {type: 'value', value: '10'}, {value: ''}],
      next: ["entity"],
      type: 'count of',
    };
    parser.feed(input);
...
describe('find expression', () => {
  ...
  it('FIND: vm.settings', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}],
      next: ["entity", 'field'],
      type: 'find',
    };
    parser.feed(input);
  ...
  it('FIND: vm.settings.owner_', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {value:''}],
      next: ['operator'],
      type: 'find',
    };
    parser.feed(input);
  ...
  it('FIND: vm.settings.owner INCLUDES', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'},{type: 'operator', value: 'INCLUDES'}, {value:''}],
      next: ['value'],
      type: 'find',
    };
    parser.feed(input);
  ...
  it('FIND: vm.settings.owner INCLUDES admin', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {type: 'operator', value: 'INCLUDES'},
  ...
  it('FIND: vm.settings.owner INCLUDES admin CHECK', () => {
    const input = 'FIND: vm.settings.owner INCLUDES admin CHECK<<caret_position>>';
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {type: 'operator', value: 'INCLUDES'},
        {type: 'value', value: 'admin'}, {value:'CHECK'} ],
      next: ['check'],
      type: 'find',
    };
    parser.feed(input);
  ...
  it('FIND: vm.settings.owner INCLUDES admin CHECK ALL:', () => {
    const input = 'FIND: vm.settings.owner INCLUDES admin CHECK ALL:<<caret_position>>';
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {type: 'operator', value: 'INCLUDES'},
        {type: 'value', value: 'admin'}, {value:''} ],
      next: ['field'],
  ...
  it('FIND: vm.settings.owner INCLUDES admin CHECK ALL: date', () => {
    const input = 'FIND: vm.settings.owner INCLUDES admin CHECK ALL: date<<caret_position>>';
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {type: 'operator', value: 'INCLUDES'},
        {type: 'value', value: 'admin'}, {type: 'field', value:'date'} ],
      next: ['field'],
      type: 'find',
    };
    parser.feed(input);
  ...
  it('FIND: vm.settings.owner INCLUDES admin CHECK ALL: date =', () => {
    ...
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {type: 'operator', value: 'INCLUDES'},
        {type: 'value', value: 'admin'}, {type: 'field', value:'date'},  {type: 'operator', value:'='}, {value:'' }],
      next: ['value'],
      type: 'find',
    };
    parser.feed(input);
  ...
  it('FIND: vm.settings.owner INCLUDES admin CHECK ALL: date = "10.9.2018"', () => {
    const input = 'FIND: vm.settings.owner INCLUDES admin CHECK ALL: date = "10.9.2018"<<caret_position>>';
    const expectedOutput = {
      results: [{type: 'entity', value: 'vm'}, {type: 'entity', value: 'settings'}, {type: 'field', value: 'owner'}, {type: 'operator', value: 'INCLUDES'},
        {type: 'value', value: 'admin'}, {type: 'field', value:'date'},  {type: 'operator', value:'='}, {type: 'value', value:'10.9.2018' }, {value:'' }],
      next: ['value'],
      type: 'find',
    };
    parser.feed(input);
