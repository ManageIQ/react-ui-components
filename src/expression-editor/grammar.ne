...
field_expression -> _ cursor {% (d) => ({results: [], next: ["entity", "exp_type"] }) %}
  ...
  | entity "." field operator value __ cursor {% (d) => ({results:[d[0], d[2], d[3], d[4], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "field" }) %}
  | entity "." field operator value __ literals cursor {% (d) => ({results:[d[0], d[2], d[3], d[4], {value: d[6]}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "field" }) %}
  ...
  | FIELD entity "." field operator value __ cursor {% (d) => ({results:[d[1], d[3], d[4], d[5], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "field" }) %}
  | FIELD entity "." field operator value __ literals cursor {% (d) => ({results:[d[1], d[3], d[4], d[5], {value: d[7]}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "field" }) %}

tags_expression -> TAGS _ cursor {% (d) => ({results: [], next: ["entity"], type: "tag" }) %}
  | TAGS entity cursor {% (d) => ({results: [d[1]].flat().map(e => ({type: e.type, value: e.value})), next: ["entity", "category"], type: "tag" }) %}
  | TAGS entity "." _ cursor {% (d) => ({results: [d[1], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["entity", "category"], type: "tag" }) %}
  | TAGS entity "." category __ cursor {% (d) => ({results:[d[1], d[3], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["tag_operator"], type: "tag" }) %}
  | TAGS entity "." category tag_operator _ cursor {% (d) => ({results:[d[1], d[3], d[4], {value: ""}].flat().map(e => ({type: e.type, value: e.value})),  next: ["value"], type: "tag" }) %}
  | TAGS entity "." category tag_operator value cursor {% (d) => ({results:[d[1], d[3], d[4], d[5]].flat().map(e => ({type: e.type, value: e.value})), next: ["value"], type: "tag" }) %}
  | TAGS entity "." category tag_operator value __ cursor {% (d) => ({results:[d[1], d[3], d[4], d[5], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "tag" }) %}
    | TAGS entity "." category tag_operator value __ literals cursor {% (d) => ({results:[d[1], d[3], d[4], d[5], {value: d[7]}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "tag" }) %}
...
count_expression -> COUNT_OF _ cursor {% (d) => ({results: [], next: ["entity"], type: "count of" }) %}
  ...
  | COUNT_OF entity_without_trailing_space __ cursor {% (d) => ({results: [d[1], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["operator"], type: "count of" }) %}
  | COUNT_OF entity_without_trailing_space __ literals cursor {% (d) => ({results: [d[1],  {type: "operator", value: d[3]}].flat().map(e => ({type: e.type, value: e.value})), next: ["operator"], type: "count of" }) %}
  | COUNT_OF entity_without_trailing_space operator _ cursor {% (d) => ({results: [d[1], d[2], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["value"], type: "count of" }) %}
  | COUNT_OF entity_without_trailing_space operator value cursor {% (d) => ({results: [d[1], d[2], d[3], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["entity"], type: "count of" }) %}
  | COUNT_OF entity_without_trailing_space operator value __ cursor {% (d) => ({results: [d[1], d[2], d[3], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "count of" }) %}
  | COUNT_OF entity_without_trailing_space operator value __ cursor {% (d) => ({results: [d[1], d[2], d[3], {value: d[5]}].flat().map(e => ({type: e.type, value: e.value})), next: ["exp_operator"], type: "count of" }) %}
...
find_expression -> FIND _ cursor {% (d) => ({results: [], next: ["entity"], type: "find" }) %}
  ...
  | FIND entity "." field operator value __ cursor {% (d) => ({results:[d[1], d[3], d[4], d[5], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["check"], type: "find" }) %}
...
check -> CHECK_ALL _ cursor {% (d) => ({results: [{value: ""}], next: ["field"], type: "find" }) %}
       ...
       | CHECK_ALL field operator value __ cursor {% (d) => ({results: [d[1], d[2], d[3], {value: ""}], next: ["exp_operator"], type: "find" }) %}
       ...
       | CHECK_ANY field operator value __ cursor {% (d) => ({results: [d[1], d[2], d[3], {value: ""}], next: ["exp_operator"], type: "find" }) %}
       ...
       | CHECK_COUNT operator value __ cursor {% (d) => ({results: [d[1], d[2], {value: ""}], next: ["exp_operator"], type: "find" }) %}
       | __ literals _ cursor {% (d) => ({results: [{value: d[1]}], next: ["check"], type: "find" }) %}
       | __ literals __ literals cursor {% (d) => ({results: [{value: d[3]}], next: ["check"], type: "find" }) %}
...
FIELD       -> _ "FIELD" _ ":" {% (d) => ( null ) %}
TAGS        -> _ "TAGS" _ ":" {% (d) => ( null ) %}
COUNT_OF    -> _ "COUNT OF" _ ":" {% (d) => ( null ) %}
FIND        -> _ "FIND" _ ":" {% (d) => ( null ) %}
REGKEY      -> _ "REGKEY" _ ":" {% (d) => ( null ) %}
CHECK_ALL   -> _ "CHECK ALL" _ ":" {% (d) => ( null ) %}
CHECK_ANY   -> _ "CHECK ANY" _ ":" {% (d) => ( null ) %}
CHECK_COUNT -> _ "CHECK COUNT" _ ":" {% (d) => ( null ) %}
_           -> [\s]:*     {% (d) => ( null ) %}
__          -> [\s]:+     {% (d) => ( null ) %}
any         -> .:*
