...
var grammar = {
    ...
    {"name": "field_expression", "symbols": ["entity", {"literal":"."}, "field", "operator", "value", "__", "cursor"], "postprocess": (d) => ({results:[d[0], d[2], d[3], d[4], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "field" })},
    {"name": "field_expression", "symbols": ["entity", {"literal":"."}, "field", "operator", "value", "__", "literals", "cursor"], "postprocess": (d) => ({results:[d[0], d[2], d[3], d[4], {value: d[6]}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "field" })},
    ...
    {"name": "field_expression", "symbols": ["FIELD", "entity", {"literal":"."}, "field", "operator", "value", "__", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], d[5], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "field" })},
    {"name": "field_expression", "symbols": ["FIELD", "entity", {"literal":"."}, "field", "operator", "value", "__", "literals", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], d[5], {value: d[7]}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "field" })},
    {"name": "tag_expression", "symbols": ["TAG", "_", "cursor"], "postprocess": (d) => ({results: [], next: ["entity"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", "cursor"], "postprocess": (d) => ({results: [d[1]].flat().map(e => ({type: e.type, value: e.value})), next: ["entity", "category"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", {"literal":"."}, "_", "cursor"], "postprocess": (d) => ({results: [d[1], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["entity", "category"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", {"literal":"."}, "category", "__", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["tag_operator"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", {"literal":"."}, "category", "tag_operator", "_", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], {value: ""}].flat().map(e => ({type: e.type, value: e.value})),  next: ["tag_field"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", {"literal":"."}, "category", "tag_operator", "value", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], d[5]].flat().map(e => ({type: e.type, value: e.value})), next: ["tag_field"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", {"literal":"."}, "category", "tag_operator", "value", "__", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], d[5], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "tag" })},
    {"name": "tag_expression", "symbols": ["TAG", "entity", {"literal":"."}, "category", "tag_operator", "value", "__", "literals", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], d[5], {value: d[7]}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "tag" })},
    ...
    {"name": "count_expression", "symbols": ["COUNT_OF", "entity_without_trailing_space", "__", "cursor"], "postprocess": (d) => ({results: [d[1], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["count_operator"], type: "count of" })},
    {"name": "count_expression", "symbols": ["COUNT_OF", "entity_without_trailing_space", "__", "literals", "cursor"], "postprocess": (d) => ({results: [d[1],  {type: "operator", value: d[3]}].flat().map(e => ({type: e.type, value: e.value})), next: ["count_operator"], type: "count of" })},
    {"name": "count_expression", "symbols": ["COUNT_OF", "entity_without_trailing_space", "count_operator", "_", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["value"], type: "count of" })},
    {"name": "count_expression", "symbols": ["COUNT_OF", "entity_without_trailing_space", "count_operator", "value", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], d[3], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["entity"], type: "count of" })},
    {"name": "count_expression", "symbols": ["COUNT_OF", "entity_without_trailing_space", "count_operator", "value", "__", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], d[3], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "count of" })},
    {"name": "count_expression", "symbols": ["COUNT_OF", "entity_without_trailing_space", "count_operator", "value", "__", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], d[3], {value: d[5]}].flat().map(e => ({type: e.type, value: e.value})), next: ["expression_operator"], type: "count of" })},
    ...
    {"name": "find_expression", "symbols": ["FIND", "entity", {"literal":"."}, "field", "operator", "value", "__", "cursor"], "postprocess": (d) => ({results:[d[1], d[3], d[4], d[5], {value: ""}].flat().map(e => ({type: e.type, value: e.value})), next: ["check_operator"], type: "find" })},
    ...
    {"name": "check", "symbols": ["CHECK_ALL", "field", "operator", "value", "__", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], d[3], {value: ""}], next: ["expression_operator"], type: "find" })},
    ...
    {"name": "check", "symbols": ["CHECK_ANY", "field", "operator", "value", "__", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], d[3], {value: ""}], next: ["expression_operator"], type: "find" })},
    ...
    {"name": "check", "symbols": ["CHECK_COUNT", "operator", "value", "__", "cursor"], "postprocess": (d) => ({results: [d[1], d[2], {value: ""}], next: ["expression_operator"], type: "find" })},
    {"name": "check", "symbols": ["__", "literals", "_", "cursor"], "postprocess": (d) => ({results: [{value: d[1]}], next: ["check_operator"], type: "find" })},
    {"name": "check", "symbols": ["__", "literals", "__", "literals", "cursor"], "postprocess": (d) => ({results: [{value: d[3]}], next: ["check_operator"], type: "find" })},
    ...
    {"name": "count_operator", "symbols": ["_", {"literal":"="}], "postprocess": (d) => ({type:'count_operator', value:d[1] })},
    {"name": "count_operator", "symbols": ["_", {"literal":"<"}], "postprocess": (d) => ({type:'count_operator', value:d[1] })},
    {"name": "count_operator", "symbols": ["_", {"literal":">"}], "postprocess": (d) => ({type:'count_operator', value:d[1] })},
    {"name": "count_operator$string$1", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "count_operator", "symbols": ["_", "count_operator$string$1"], "postprocess": (d) => ({type:'count_operator', value:d[1] })},
    {"name": "count_operator$string$2", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "count_operator", "symbols": ["_", "count_operator$string$2"], "postprocess": (d) => ({type:'count_operator', value:d[1] })},
    ...
    {"name": "FIELD$subexpression$1$string$1", "symbols": [{"literal":"F"}, {"literal":"I"}, {"literal":"E"}, {"literal":"L"}, {"literal":"D"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "FIELD$subexpression$1", "symbols": ["FIELD$subexpression$1$string$1"]},
    {"name": "FIELD$subexpression$1$string$2", "symbols": [{"literal":"F"}, {"literal":"i"}, {"literal":"e"}, {"literal":"l"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "FIELD$subexpression$1", "symbols": ["FIELD$subexpression$1$string$2"]},
    {"name": "FIELD", "symbols": ["_", "FIELD$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "TAG$subexpression$1$string$1", "symbols": [{"literal":"T"}, {"literal":"A"}, {"literal":"G"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "TAG$subexpression$1", "symbols": ["TAG$subexpression$1$string$1"]},
    {"name": "TAG$subexpression$1$string$2", "symbols": [{"literal":"T"}, {"literal":"a"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "TAG$subexpression$1", "symbols": ["TAG$subexpression$1$string$2"]},
    {"name": "TAG", "symbols": ["_", "TAG$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "COUNT_OF$subexpression$1$string$1", "symbols": [{"literal":"C"}, {"literal":"O"}, {"literal":"U"}, {"literal":"N"}, {"literal":"T"}, {"literal":" "}, {"literal":"O"}, {"literal":"F"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "COUNT_OF$subexpression$1", "symbols": ["COUNT_OF$subexpression$1$string$1"]},
    {"name": "COUNT_OF$subexpression$1$string$2", "symbols": [{"literal":"C"}, {"literal":"o"}, {"literal":"u"}, {"literal":"n"}, {"literal":"t"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "COUNT_OF$subexpression$1", "symbols": ["COUNT_OF$subexpression$1$string$2"]},
    {"name": "COUNT_OF", "symbols": ["_", "COUNT_OF$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "FIND$subexpression$1$string$1", "symbols": [{"literal":"F"}, {"literal":"I"}, {"literal":"N"}, {"literal":"D"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "FIND$subexpression$1", "symbols": ["FIND$subexpression$1$string$1"]},
    {"name": "FIND$subexpression$1$string$2", "symbols": [{"literal":"F"}, {"literal":"i"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "FIND$subexpression$1", "symbols": ["FIND$subexpression$1$string$2"]},
    {"name": "FIND", "symbols": ["_", "FIND$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "REGKEY$subexpression$1$string$1", "symbols": [{"literal":"R"}, {"literal":"E"}, {"literal":"G"}, {"literal":"K"}, {"literal":"E"}, {"literal":"Y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "REGKEY$subexpression$1", "symbols": ["REGKEY$subexpression$1$string$1"]},
    {"name": "REGKEY$subexpression$1$string$2", "symbols": [{"literal":"R"}, {"literal":"e"}, {"literal":"g"}, {"literal":"k"}, {"literal":"e"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "REGKEY$subexpression$1", "symbols": ["REGKEY$subexpression$1$string$2"]},
    {"name": "REGKEY", "symbols": ["_", "REGKEY$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "CHECK_ALL$subexpression$1$string$1", "symbols": [{"literal":"C"}, {"literal":"H"}, {"literal":"E"}, {"literal":"C"}, {"literal":"K"}, {"literal":" "}, {"literal":"A"}, {"literal":"L"}, {"literal":"L"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CHECK_ALL$subexpression$1", "symbols": ["CHECK_ALL$subexpression$1$string$1"]},
    {"name": "CHECK_ALL$subexpression$1$string$2", "symbols": [{"literal":"C"}, {"literal":"h"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}, {"literal":" "}, {"literal":"a"}, {"literal":"l"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CHECK_ALL$subexpression$1", "symbols": ["CHECK_ALL$subexpression$1$string$2"]},
    {"name": "CHECK_ALL", "symbols": ["_", "CHECK_ALL$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "CHECK_ANY$subexpression$1$string$1", "symbols": [{"literal":"C"}, {"literal":"H"}, {"literal":"E"}, {"literal":"C"}, {"literal":"K"}, {"literal":" "}, {"literal":"A"}, {"literal":"N"}, {"literal":"Y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CHECK_ANY$subexpression$1", "symbols": ["CHECK_ANY$subexpression$1$string$1"]},
    {"name": "CHECK_ANY$subexpression$1$string$2", "symbols": [{"literal":"C"}, {"literal":"h"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}, {"literal":" "}, {"literal":"a"}, {"literal":"n"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CHECK_ANY$subexpression$1", "symbols": ["CHECK_ANY$subexpression$1$string$2"]},
    {"name": "CHECK_ANY", "symbols": ["_", "CHECK_ANY$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
    {"name": "CHECK_COUNT$subexpression$1$string$1", "symbols": [{"literal":"C"}, {"literal":"H"}, {"literal":"E"}, {"literal":"C"}, {"literal":"K"}, {"literal":" "}, {"literal":"C"}, {"literal":"O"}, {"literal":"U"}, {"literal":"N"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CHECK_COUNT$subexpression$1", "symbols": ["CHECK_COUNT$subexpression$1$string$1"]},
    {"name": "CHECK_COUNT$subexpression$1$string$2", "symbols": [{"literal":"C"}, {"literal":"h"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}, {"literal":" "}, {"literal":"c"}, {"literal":"o"}, {"literal":"u"}, {"literal":"n"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CHECK_COUNT$subexpression$1", "symbols": ["CHECK_COUNT$subexpression$1$string$2"]},
    {"name": "CHECK_COUNT", "symbols": ["_", "CHECK_COUNT$subexpression$1", "_", {"literal":":"}], "postprocess": (d) => ( null )},
